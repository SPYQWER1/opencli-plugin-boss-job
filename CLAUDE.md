...
# 删除附件简历
opencli boss-job resume-delete <resume-id>
```
...
- `/wapi/zpgeek/resume/attachment/delete.json` - 删除附件简历（POST, body: resumeId=..., 需要 zp_token 请求头）
